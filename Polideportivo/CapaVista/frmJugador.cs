...
namespace CapaVista
{
    public partial class frmJugador : Form
    {
        public frmJugador()
        {
			...
			navegador1.ObtenerCamposdeTabla(alias, "jugadorPoli", "hotelSanCarlos");
			navegador1.MetodoSalirVista(this);
			navegador1.LlenarCombobox(cbxIDEquipo, "equipoPoli", "pkId", "nombre", "estado");
		...
		{
			navegador1.SeleccionarElementosenCombo(cbxIDEquipo, txtIDEquipo);
		}

		private void cbxIDEmpresa_SelectedIndexChanged(object sender, EventArgs e)
		{
			navegador1.EnviarDatoComboaTextbox(cbxIDEquipo, txtIDEquipo);
		}
