...
namespace CapaVista
{
	public partial class frmCampeonato : Form
	{
		public frmCampeonato()
		{
			...
			navegador1.ObtenerCamposdeTabla(alias, "campeonatoPoli", "hotelSanCarlos");
			navegador1.MetodoSalirVista(this);
			navegador1.LlenarCombobox(cbxIDSede, "sedePoli", "pkId", "nombre", "estado");
		...
		{
			navegador1.SeleccionarElementosenCombo(cbxIDSede, txtIDSede);
		}

		private void cbxIDEmpresa_SelectedIndexChanged(object sender, EventArgs e)
		{
			navegador1.EnviarDatoComboaTextbox(cbxIDSede, txtIDSede);
		}
	}
}