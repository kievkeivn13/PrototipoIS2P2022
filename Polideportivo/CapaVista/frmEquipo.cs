...
namespace CapaVista
{
    public partial class frmEquipo : Form
    {
        public frmEquipo()
        {
			...
			navegador1.ObtenerCamposdeTabla(alias, "equipoPoli", "hotelSanCarlos");
			navegador1.MetodoSalirVista(this);
			navegador1.LlenarCombobox(cbxIDEntrenador, "entrenadorPoli", "pkId", "nombre", "estado");
			navegador1.LlenarCombobox(cbxTipoDeporte, "tipodeportePoli", "pkId", "nombre", "estado");
        ...
        private void txtIDEntrenador_TextChanged(object sender, EventArgs e)
        {
			navegador1.SeleccionarElementosenCombo(cbxIDEntrenador, txtIDEntrenador);
		}

        private void txtTipoDeporte_TextChanged(object sender, EventArgs e)
        {
			navegador1.SeleccionarElementosenCombo(cbxTipoDeporte, txtTipoDeporte);
		}

        private void cbxIDEntrenador_SelectedIndexChanged(object sender, EventArgs e)
        {
			navegador1.EnviarDatoComboaTextbox(cbxIDEntrenador, txtIDEntrenador);
		}

        private void cbxTipoDeporte_SelectedIndexChanged(object sender, EventArgs e)
        {
			navegador1.EnviarDatoComboaTextbox(cbxTipoDeporte, txtTipoDeporte);
		}
    }
}
